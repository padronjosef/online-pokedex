  ...
  projects: [
    {
      ...
      description:"My personal portfolio made from scratch react.js, sass, webpack, aos and gh-pages, it is a project on develop because I like to implement all the new technologies that i'm learning on it",
    ...
    },
    {
      ...
      description:"An small CRUD app where I used react, json fake api to simulate the landing page of a fictitious react event.",
    ...
    },
    {
      ...
      description:"I am a space fanatic so I created this landing page to simulate the next launch to Mars, assuming it can already be visited commercially.",
