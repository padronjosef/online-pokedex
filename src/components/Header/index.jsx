      ...
      <header className="header" id="header">
        <nav className="navbar">
          <a href="#" className="logo">
            <img className="logo__img" onClick={closeMenu} src={logo.img} alt={logo.alt}/>
          </a>
          <Scrollspy className="menu" id="menu" items={ ['main', 'stack', 'portfolio', 'studies', 'blog', 'footer'] } currentClassName="menu__item--active" offset={-100}>
            ...
            <li className="menu__item"><a href="#stack" onClick={closeMenu} className="menu__link">Stack</a></li>
            <li className="menu__item"><a href="#portfolio" onClick={closeMenu} className="menu__link">Portfolio</a></li>
            <li className="menu__item"><a href="#studies" onClick={closeMenu} className="menu__link">Studies</a></li>
            <li className="menu__item"><a href="#blog" onClick={closeMenu} className="menu__link">Blog</a></li>
            <li className="menu__item"><a href="#footer" onClick={closeMenu} className="menu__link">Contact</a></li>
          </Scrollspy>
